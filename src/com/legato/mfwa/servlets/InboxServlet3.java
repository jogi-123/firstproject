...
*/
@WebServlet("/InboxServlet3")
public class InboxServlet3 extends HttpServlet {
...
out.print("<html><head><title>InboxServlet3</title></head><body>");
out.print("<h1 style='margin-left:40%;'>Inbox2 </h1>");
out.print("<h2> Welcome" +userName+"</h2>");
out.print("<h2> Location" +location+"</h2>");
out.print("<a href='SentItemsServlet3'/>Sent Item Servlet3</a>");
out.print("<br/>");
out.print("<a href='LogOut3'/>logout3</a>");
out.print("</body></html>");
}
